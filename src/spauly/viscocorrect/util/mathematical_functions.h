#ifndef SPAULY_VISCOCORRECT_SRC_UTIL_MATHEMATICAL_FUNCTIONS_H
#define SPAULY_VISCOCORRECT_SRC_UTIL_MATHEMATICAL_FUNCTIONS_H
...
#endif // SPAULY_VISCOCORRECT_SRC_UTIL_MATHEMATICAL_FUNCTIONS_H