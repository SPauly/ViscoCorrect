...
namespace viscocorrect
{
    ...
    private:
        ...
        void CreateLineCoords(GraphLineStorage *coords, const std::map<int, int> *raw_points, const double pitch, const int *startpos, bool scale_on_x = true, bool use_same_x = false);
